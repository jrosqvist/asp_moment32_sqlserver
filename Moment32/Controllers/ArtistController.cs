...
namespace Moment32.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Nationality")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Nationality")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
